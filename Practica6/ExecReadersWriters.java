...
public class ExecReadersWriters {
    ...
    private static void taskR(NewFifoReadWriteLock rw) {//Runnable para el lock Read
    ...
    private static void taskW(NewFifoReadWriteLock rw) {//Runnable para el lock Write
        String threadName = Thread.currentThread().getName();//Obtenemos el nombre del hilo
		try {
			rw.writeLock().lock();	
    ...
    public static void main(String[] args) {
		...
		NewFifoReadWriteLock rwLock = new NewFifoReadWriteLock(); 
