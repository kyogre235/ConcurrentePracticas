...
public class RunnableQ2<T> implements Runnable{
	private int item;
	ConcurrentLinkedQueue<Integer> queue;
	Collect<String> snapshotI;
	Collect<String> snapshotR;
    private int num;
    public RunnableQ2(int item, ConcurrentLinkedQueue<Integer> queue, 
    		int num, Collect<String> snapshotI, Collect<String> snapshotR){
        this.item = item;
        this.queue = queue;
