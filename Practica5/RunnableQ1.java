...
public class RunnableQ1<T> implements Runnable{
	private int item;
	ConcurrentLinkedQueue<Integer> queue;
	OFSnapshotH<String> snapshotI;
	OFSnapshotH<String> snapshotR;
    private int num;
    public RunnableQ1(int item, ConcurrentLinkedQueue<Integer> queue, 
    		int num, OFSnapshotH<String> snapshotI, OFSnapshotH<String> snapshotR){
        this.item = item;
        this.queue = queue;
